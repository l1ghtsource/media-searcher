...
Полученные 31000 эмбеддингов кластеризовали с *PCA* и *hdbscan*, получили 138 кластеров, из них отобрали 80 качественных. Добавление нового видео происходит, основываясь на среднем векторе кластера, аналогично тому, как это сделано в тематических кластерах.
